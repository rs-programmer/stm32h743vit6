...
#define CDC_HS_BINTERVAL 0xFFU
#endif /* CDC_HS_BINTERVAL */

#ifndef CDC_FS_BINTERVAL
#define CDC_FS_BINTERVAL 0xFFU
...
#define USB_CDC_CONFIG_DESC_SIZ 60U
...
uint8_t USBD_CDC_SetTxBuffer(
    USBD_HandleTypeDef *pdev, uint8_t *pbuff, uint32_t length, uint8_t ClassId);
