...
#define LCD_RST(x)                                                                                 \
    do {                                                                                           \
        x ? HAL_GPIO_WritePin(LCD_RST_GPIO_PORT, LCD_RST_GPIO_PIN, GPIO_PIN_SET)                   \
 ...
 * 首先FMC_NE1的基地址为: 0X6000 0000;     NEx的基址为(x=1/2/3/4): 0X6000 0000 + (0X400 0000 * (x -
 * 1)) FMC_A19对应地址值: 2^19 * 2 = 0X100000;       FMC_Ay对应的地址为(y = 0 ~ 25): 2^y * 2
 *
 ...
 */
#define LCD_BASE                                                                                   \
    (uint32_t)((0X60000000 + (0X4000000 * (LCD_FMC_NEX - 1))) | (((1 << LCD_FMC_AX) * 2) - 2))
#define LCD_REG_ADDR (LCD_BASE + offsetof(LCD_TypeDef, LCD_REG))
#define LCD_RAM_ADDR (LCD_BASE + offsetof(LCD_TypeDef, LCD_RAM))
